...
const CATALOG = [
  ...
  },
  {
    ...
    products: [
      ...
      { name: '14 Impulsos Mensal', priceCents: cents(10) },
      { name: '24 Impulsos Mensal', priceCents: cents(15) },
      { name: '14 Impulsos Trimensal', priceCents: cents(20) },
      { name: '24 Impulsos Trimensal', priceCents: cents(30) },
    ],
  },
  {
    category: 'Nitradas',
